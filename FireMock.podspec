#
#  Be sure to run `pod spec lint FireMock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/Magiic/FireMock.git', :tag => "1.0.4" }
  ...
  s.source_files  = "FireMock", "FireMock/**/*.{h,m, swift}"
